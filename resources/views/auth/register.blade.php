...
<title>{{ App\Models\Settings::get('app.name', '🦁 example') }} > {{ __('Konto erstellen') }}</title>
...
<div class="col-6">
<div class="mb-1">
<input type="text" class="form-control" id="login-captcha" name="captcha" placeholder="..." maxlength="30" aria-describedby="login-captcha" tabindex="4" autofocus />
</div>
</div>
