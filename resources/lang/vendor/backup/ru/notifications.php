...
return [
    ...
    'disk' => 'Диск',
    'newest_backup_size' => 'Самый новый размер резервной копии',
    'number_of_backups' => 'Количество резервных копий',
    'total_storage_used' => 'Общий объем используемого хранилища',
    'newest_backup_date' => 'Самый новый размер резервной копии',
    'oldest_backup_date' => 'Размер самой старой резервной копии',
];
